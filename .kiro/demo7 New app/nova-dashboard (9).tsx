      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-4 space-y-3">
            {[
              { icon: '⚠️', title: 'Bottleneck Detected', desc: 'Code Review delaying 8 tasks', confidence: 94 },
      ...
      <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6 justify-between sticky top-0 z-50">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-semibold text-gray-900">NOVA</span>
          </div>
          <div className="hidden md:flex items-center gap-2 text-sm text-gray-600">
            <span>TechCorp Mobile</span>
