...
import { mockIssues, mockSprints, mockUsers } from "@/lib/mock-data"
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button variant="outline" className="w-full bg-transparent" asChild>
              <Link href="/demo/issues?filter=urgent">Zobacz wszystkie pilne</Link>
            </Button>
          </CardContent>
        </Card>
