...
export default function Demo2() {
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground">
      {/* Demo Mode Banner */}
      <div className="bg-primary text-primary-foreground px-4 py-2 text-sm flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <span className="font-medium">Demo2 Mode</span>
          <span className="opacity-80">Ultra-szczegółowy koncept design (v1.0)</span>
        </div>
